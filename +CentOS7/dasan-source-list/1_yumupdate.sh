...
echo ""
echo -e  "\033[1;34m${PROMPT} yum -y update \033[0m"
yum -y update
...
echo -e  "\033[1;34m${PROMPT} grep 'SELINUX=' /etc/sysconfig/selinux  \033[0m"
...
echo " 설정 변경. "
echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/default/grub  기존 설정 내용 확인 \033[0m"
cat /etc/default/grub

echo ""
echo -e  "\033[1;34m${PROMPT} sed -i  's/rhgb//'   /etc/default/grub  부팅시 화면에 부팅로그가 표시 되도록 rhgb 항목 지움 \033[0m"
sed -i  's/rhgb//'   /etc/default/grub

echo ""
echo -e  "\033[1;34m${PROMPT} sed -i  's/quiet//'  /etc/default/grub   # 부팅시 화면에 부팅로그가 표시 되도록 quiet 항목 지움 \033[0m"
...
echo " ipv6 비활성 "
echo ""
echo -e  "\033[1;34m${PROMPT} sed -i  's/GRUB_CMDLINE_LINUX="/GRUB_CMDLINE_LINUX="ipv6.disable=1 /' /etc/default/grub \033[0m"
sed -i  's/GRUB_CMDLINE_LINUX="/GRUB_CMDLINE_LINUX="ipv6.disable=1 /' /etc/default/grub

echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/default/grub   변경사항 확인 \033[0m"
cat /etc/default/grub
