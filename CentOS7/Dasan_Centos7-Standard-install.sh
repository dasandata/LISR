...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '13s/Dasan_Centos7-Standard-install.sh/Dasan_Centos7-nouveau.sh/g' /etc/rc.local   \033[0m" >> /root/Dasan_command.txt
sed -i '13s/Dasan_Centos7-Standard-install.sh/Dasan_Centos7-nouveau.sh/g' /etc/rc.local
