...
yum install -y cmake python-devel ntfs-3g dstat perl perl-CPAN perl-core net-tools openssl-devel smartmontools >>  dasan_log_install_centos_default_util.txt 2>&1
