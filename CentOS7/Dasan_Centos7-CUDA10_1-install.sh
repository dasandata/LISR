...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '13s/Dasan_Centos7-CUDA10_1-install.sh/Dasan_Centos7-CUDA10_2-install.sh/g' /etc/rc.d/rc.local    \033[0m" >> /root/Dasan_command.txt
