...
echo "===== blacklist nouveau check =====" | tee -a /root/LAS_Install_Log.txt
...
case $OSCHECK in 
    centos )
        echo "===== firewall service Check ====="  | tee -a /root/LAS_Install_Log.txt
        systemctl status firewalld  >> /root/LAS_Install_Log.txt
        echo ""  | tee -a /root/LAS_Install_Log.txt
        echo "===== firewall port Check ====="  | tee -a /root/LAS_Install_Log.txt
...
echo ""  | tee -a /root/LAS_Install_Log.txt
racadm get system.ServerInfo  >> /root/LAS_Install_Log.txt
echo ""  | tee -a /root/LAS_Install_Log.txt
