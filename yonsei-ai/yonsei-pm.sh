...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w yonsei-ai-login[1-2] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eno1 | grep -i speed ; echo ' | sort -V " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w yonsei-ai-login[1-2] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eno1 | grep -i speed ; echo ' | sort -V | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w fpga[1-3] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eno1 | grep -i speed ; echo ' | sort -V " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w fpga[1-3] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eno1 | grep -i speed ; echo ' | sort -V | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w node[01-33] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eth0 | grep -i speed ; echo ' | sort -V " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w node[01-33] 'date "+%Y-%m-%d %H:%M:%S" ; ethtool eth0 | grep -i speed ; echo ' | sort -V | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w node[01-33] 'date "+%Y-%m-%d %H:%M:%S" ; uptime' | sort -V " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w node[01-33] 'date "+%Y-%m-%d %H:%M:%S" ; uptime' | sort -V | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w login[1,2] dmidecode | grep -A3 "BIOS Information" " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w login[1,2] dmidecode | grep -A3 "BIOS Information"  | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} pdsh -w fpga[1-3] dmidecode | grep -A3 "BIOS Information" " >> "/root/dasan_Maintenance_${date1}.txt"
pdsh -w fpga[1-3] dmidecode | grep -A3 "BIOS Information" | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} for i in $(seq 1 9) ; do ssh node0${i} dmidecode | grep -A3 "BIOS Information" ; done " >> "/root/dasan_Maintenance_${date1}.txt"
for i in $(seq 1 9) ; do ssh node0${i} dmidecode | grep -A3 "BIOS Information" ; done | tee -a "$LOGFILE"
...
echo ""
echo -e  "${PROMPT} ${date1} " >> "/root/dasan_Maintenance_${date1}.txt"
echo -e  "${PROMPT} for i in $(seq 10 33) ; do ssh node${i} dmidecode | grep -A3 "BIOS Information" ; done " >> "/root/dasan_Maintenance_${date1}.txt"
for i in $(seq 10 33) ; do ssh node${i} dmidecode | grep -A3 "BIOS Information" ; done  | tee -a "$LOGFILE"
