...
echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/apt/sources.list | grep -v \"#\|^$\" \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} perl -pi -e 's/security.ubuntu.com/mirror.kakao.com/g' /etc/apt/sources.list \033[0m" >> Dasan_command.txt
...
echo "  기본 유틸 설치. "
echo -e  "\033[1;34m${PROMPT} apt-get install -y vim nfs-common rdate xauth firefox gcc make ifconfig \033[0m" >> Dasan_command.txt
echo -e  "\033[1;34m${PROMPT} apt-get install -y locate htop tmux git wget \033[0m" >> Dasan_command.txt
echo -e  "\033[1;34m${PROMPT} apt-get install -y xfsprogs ntfs-3g aptitude lvm2 dstat curl smartmontools \033[0m" >> Dasan_command.txt
apt-get install -y  \
...
echo "  서버 시간 동기화. "
echo -e  "\033[1;34m${PROMPT} rdate  -s  time.bora.net \033[0m" >> Dasan_command.txt
rdate  -s  time.bora.net
echo ""

echo -e  "\033[1;34m${PROMPT} hwclock --systohc \033[0m" >> Dasan_command.txt
hwclock --systohc
echo ""

echo -e  "\033[1;34m${PROMPT} date \033[0m" >> Dasan_command.txt
date
echo ""

echo -e  "\033[1;34m${PROMPT} hwclock \033[0m" >> Dasan_command.txt
hwclock
echo ""
...
echo ""
echo -e  "\033[1;34m${PROMPT} echo "add by dasandata"             >>   /etc/profile \033[0m" >> Dasan_command.txt
echo "# add by dasandata"             >>   /etc/profile

echo ""
echo -e  "\033[1;34m${PROMPT} echo "alias vi='vim' "                        >>   /etc/profile \033[0m" >> Dasan_command.txt
echo "alias vi='vim' "                        >>   /etc/profile

echo ""
echo -e  "\033[1;34m${PROMPT} echo "alias ls='ls --color=auto' "       >>   /etc/profile \033[0m" >> Dasan_command.txt
echo "alias ls='ls --color=auto' "       >>   /etc/profile

echo ""
echo -e  "\033[1;34m${PROMPT} echo "alias ll='ls -lh' "                        >>   /etc/profile \033[0m" >> Dasan_command.txt
echo "alias ll='ls -lh' "                        >>   /etc/profile

echo ""
echo -e  "\033[1;34m${PROMPT} echo "alias grep='grep --color=auto' "   >>   /etc/profile \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} echo $HISTSIZE \033[0m" >> Dasan_command.txt
echo  $HISTSIZE

echo ""
echo -e  "\033[1;34m${PROMPT} grep HISTSIZE /etc/skel/.bashrc \033[0m" >> Dasan_command.txt
grep HISTSIZE /etc/skel/.bashrc

echo ""
echo -e  "\033[1;34m${PROMPT} perl -pi -e  's/HISTSIZE=1000/HISTSIZE=100000/'   /etc/skel/.bashrc \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} grep HISTSIZE .bashrc \033[0m" >> Dasan_command.txt
grep HISTSIZE .bashrc

echo ""
echo -e  "\033[1;34m${PROMPT} perl -pi -e 's/HISTSIZE=1000/HISTSIZE=100000/'   ~/.bashrc \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} echo " Add timestamp to .bash_history "  >> /etc/profile \033[0m" >> Dasan_command.txt
echo "# Add timestamp to .bash_history "  >> /etc/profile

echo ""
echo -e  "\033[1;34m${PROMPT} echo 'export HISTTIMEFORMAT="20%y/%m/%d %T "' >> /etc/profile \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} echo "export PS1='\[\e[1;46;30m\][\u@\h:\W]\\$\[\e[m\] '" >> /root/.bashrc \033[0m" >> Dasan_command.txt
echo "export PS1='\[\e[1;46;30m\][\u@\h:\W]\\$\[\e[m\] '" >> /root/.bashrc

echo ""
echo -e  "\033[1;34m${PROMPT} tail -1 /root/.bashrc \033[0m" >> Dasan_command.txt
tail -1 /root/.bashrc

echo ""
echo ""
echo -e  "\033[1;34m${PROMPT} echo "export PS1='\[\e[1;47;30m\][\u@\h:\W]\\$\[\e[m\] '" >> /home/sonic/.bashrc \033[0m" >> Dasan_command.txt
echo "export PS1='\[\e[1;47;30m\][\u@\h:\W]\\$\[\e[m\] '" >> /home/sonic/.bashrc

echo ""
echo -e  "\033[1;34m${PROMPT} tail -1 /home/sonic/.bashrc \033[0m" >> Dasan_command.txt
...
echo "  적용확인. "
echo -e  "\033[1;34m${PROMPT} tail -10 /etc/profile \033[0m" >> Dasan_command.txt
tail -10 /etc/profile
...
echo -e  "\033[1;34m${PROMPT} ip a \033[0m" >> Dasan_command.txt
ip a
echo ""
echo -e  "\033[1;34m${PROMPT} EXT_NIC=$(ip a | grep 'state UP' | cut -d ":" -f 2 |tr -d ' ') \033[0m" >> Dasan_command.txt
EXT_NIC=$(ip a | grep 'state UP' | cut -d ":" -f 2 |tr -d ' ')
echo ""
echo -e  "\033[1;34m${PROMPT} echo ${EXT_NIC}  # 추출된 인터페이스 명이 맞는지 확인 필요. \033[0m" >> Dasan_command.txt
echo ${EXT_NIC}

echo ""
echo ""

echo -e  "\033[1;34m${PROMPT} ifconfig  ${EXT_NIC} \033[0m" >> Dasan_command.txt
ifconfig  ${EXT_NIC}
echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/network/interfaces \033[0m" >> Dasan_command.txt
cat /etc/network/interfaces
echo ""

echo -e  "\033[1;34m${PROMPT} cat /etc/hostname \033[0m" >> Dasan_command.txt
cat /etc/hostname
echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/resolv.conf \033[0m" >> Dasan_command.txt
cat /etc/resolv.conf
echo ""
echo -e  "\033[1;34m${PROMPT} ping -c 4 google.com \033[0m" >> Dasan_command.txt
ping -c 4 google.com
echo ""
...
echo ""
echo -e  "\033[1;34m${PROMPT} systemctl get-default # 부팅시 정보 확인 \033[0m" >> Dasan_command.txt
systemctl get-default

echo ""
echo -e  "\033[1;34m${PROMPT} systemctl set-default multi-user.target # 부팅시 터미널 모드 변경 \033[0m" >> Dasan_command.txt
systemctl set-default multi-user.target

echo ""
echo -e  "\033[1;34m${PROMPT} systemctl get-default # 변경 정보 확인 \033[0m" >> Dasan_command.txt
systemctl get-default

echo " ubuntu desktop 설치 "
echo ""
echo -e  "\033[1;34m${PROMPT} apt-get -y install ubuntu-desktop gnome-panel gnome-settings-daemon  \033[0m" >> Dasan_command.txt
echo -e  "\033[1;34m${PROMPT} apt-get -y install metacity nautilus gnome-terminal \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} systemctl list-unit-files  -t service  | grep enable \033[0m" >> Dasan_command.txt
systemctl list-unit-files  -t service  | grep enable

echo ""
echo " Daemon Disable 스크립트 실행. "
echo -e  "\033[1;34m${PROMPT} cat /root/LISR/common/dasan_ubuntu_daemon_disable.sh \033[0m" >> Dasan_command.txt
cat /root/LISR/common/dasan_ubuntu_daemon_disable.sh

echo ""
echo -e  "\033[1;34m${PROMPT} bash /root/LISR/common/dasan_ubuntu_daemon_disable.sh  \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} systemctl status ufw \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} ufw default deny \033[0m" >> Dasan_command.txt
ufw default deny

echo ""
echo -e  "\033[1;34m${PROMPT} ufw allow 22/tcp \033[0m" >> Dasan_command.txt
ufw allow 22/tcp

echo ""
echo -e  "\033[1;34m${PROMPT} ufw allow 7777/tcp \033[0m" >> Dasan_command.txt
ufw allow 7777/tcp

echo ""
echo -e  "\033[1;34m${PROMPT} ufw status numbered \033[0m" >> Dasan_command.txt
ufw status numbered
...
echo ""
echo -e  "\033[1;34m${PROMPT} grep 'Root\|Port' /etc/ssh/sshd_config \033[0m" >> Dasan_command.txt
grep 'Root\|Port' /etc/ssh/sshd_config

echo ""
echo -e  "\033[1;34m${PROMPT} perl -pi -e "s/Port 22/Port 7777/g" /etc/ssh/sshd_config \033[0m" >> Dasan_command.txt
perl -pi -e "s/Port 22/Port 7777/g" /etc/ssh/sshd_config

echo ""
echo -e  "\033[1;34m${PROMPT} perl -pi -e "s/PermitRootLogin prohibit-password/PermitRootLogin no/g" /etc/ssh/sshd_config \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} echo "AddressFamily inet" >> /etc/ssh/sshd_config \033[0m" >> Dasan_command.txt
echo "AddressFamily inet" >> /etc/ssh/sshd_config

echo ""
echo -e  "\033[1;34m${PROMPT} grep AddressFamily /etc/ssh/sshd_config \033[0m" >> Dasan_command.txt
grep AddressFamily /etc/ssh/sshd_config
echo ""

echo -e  "\033[1;34m${PROMPT} systemctl restart sshd \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} NEW_USER=dasan \033[0m" >> Dasan_command.txt
NEW_USER=dasan

echo ""
echo -e  "\033[1;34m${PROMPT} echo ${NEW_USER}\033[0m" >> Dasan_command.txt
echo ${NEW_USER}
...
echo ""
echo -e  "\033[1;34m${PROMPT} grep ${NEW_USER} /etc/group \033[0m" >> Dasan_command.txt
grep ${NEW_USER} /etc/group

echo ""
echo -e  "\033[1;34m${PROMPT} usermod -G sudo ${NEW_USER} \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} ip a | grep inet6 \033[0m" >> Dasan_command.txt
ip a | grep inet6
...
echo "  설정 변경 "
echo -e  "\033[1;34m${PROMPT} cat /etc/default/grub | grep -v #\|^$ \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} perl -pi -e 's/splash//' /etc/default/grub \033[0m" >> Dasan_command.txt
perl -pi -e 's/splash//' /etc/default/grub

echo ""
echo "  부팅시 화면에 부팅로그가 표시 되도록 quiet 항목 지움 "
echo -e  "\033[1;34m${PROMPT} perl -pi -e 's/quiet//'  /etc/default/grub \033[0m" >> Dasan_command.txt
...
echo "  ipv6 비활성 "
echo -e  "\033[1;34m${PROMPT} perl -pi -e  's/^GRUB_CMDLINE_LINUX="/GRUB_CMDLINE_LINUX="ipv6.disable=1 /'  /etc/default/grub \033[0m" >> Dasan_command.txt
perl -pi -e  's/^GRUB_CMDLINE_LINUX="/GRUB_CMDLINE_LINUX="ipv6.disable=1 /'  /etc/default/grub

echo ""

echo "  timeout 옵션 해제 "
echo -e  "\033[1;34m${PROMPT} perl -pi -e  's/^GRUB_HIDDEN_TIMEOUT=/#GRUB_HIDDEN_TIMEOUT=/'  /etc/default/grub \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} update-initramfs -u && update-grub2 \033[0m" >> Dasan_command.txt
