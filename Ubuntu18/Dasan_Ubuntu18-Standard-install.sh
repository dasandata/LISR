...
echo "  기본 유틸 설치. "
echo -e  "\033[1;34m${PROMPT} apt-get install -y vim nfs-common rdate xauth firefox gcc make net-tools \033[0m" >> Dasan_command.txt
...
apt-get install -y  \
vim nfs-common rdate xauth firefox gcc make locate htop tmux git wget net-tools \
...
echo -e  "\033[1;34m${PROMPT} apt-get install -y python-dev \033[0m" >> Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} cat /etc/netplan/01-netcfg.yaml \033[0m" >> Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} apt-get -y install ubuntu-desktop  \033[0m" >> Dasan_command.txt
