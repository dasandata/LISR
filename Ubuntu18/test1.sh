...
echo -e  "\033[1;34m${PROMPT} apt-get install -y python-dev \033[0m" >> /root/Dasan_command.txt
...
echo -e  "\033[1;34m${PROMPT} cat /etc/netplan/01-netcfg.yaml \033[0m" >> /root/Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} apt-get -y install ubuntu-desktop  \033[0m" >> /root/Dasan_command.txt
...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '13a bash /root/LISR/Ubuntu18/test1.sh >> /root/dasan_install_log.txt' /etc/rc.local  \033[0m" >> /root/Dasan_command.txt
sed -i '13a bash /root/LISR/Ubuntu18/test1.sh >> /root/dasan_install_log.txt' /etc/rc.local
