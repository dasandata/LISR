...
echo ""
echo -e  "\033[1;34m${PROMPT} wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/cuda-repo-ubuntu1804_10.0.130-1_amd64.deb \033[0m" >> /root/dasan_install_log.txt
wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/cuda-repo-ubuntu1804_10.0.130-1_amd64.deb

echo ""
echo -e  "\033[1;34m${PROMPT} dpkg -i cuda-repo-ubuntu1804_10.0.130-1_amd64.deb \033[0m" >> /root/dasan_install_log.txt
...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '2s/Dasan_Ubuntu18-CUDA10_1-install.sh/Dasan_Ubuntu18-CUDA10_2-install.sh/g' /etc/rc.local  \033[0m" >> /root/dasan_install_log.txt
