...
echo ""
echo -e  "\033[1;34m${PROMPT} wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/cuda-repo-ubuntu1804_10.0.130-1_amd64.deb \033[0m" >> /root/Dasan_command.txt
wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/cuda-repo-ubuntu1804_10.0.130-1_amd64.deb

echo ""
echo -e  "\033[1;34m${PROMPT} dpkg -i cuda-repo-ubuntu1804_10.0.130-1_amd64.deb \033[0m" >> /root/Dasan_command.txt
dpkg -i cuda-repo-ubuntu1804_10.0.130-1_amd64.deb

echo ""
echo -e  "\033[1;34m${PROMPT} wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/7fa2af80.pub \033[0m" >> /root/Dasan_command.txt
wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/7fa2af80.pub

echo ""
echo -e  "\033[1;34m${PROMPT} apt-key add 7fa2af80.pub \033[0m" >> /root/Dasan_command.txt
apt-key add 7fa2af80.pub

echo ""
echo -e  "\033[1;34m${PROMPT} cat /etc/apt/sources.list.d/cuda.list \033[0m" >> /root/Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} apt-cache  search   cuda \033[0m" >> /root/Dasan_command.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} apt-get install -y cuda-10-0 \033[0m" >> /root/Dasan_command.txt
apt-get install -y cuda-10-0  >> dasan_log_install_cuda9.txt   2>&1
...
echo ""
echo -e  "\033[1;34m${PROMPT} pip   install --upgrade pip \033[0m" >> /root/Dasan_command.txt
pip   install --upgrade pip

echo ""
echo -e  "\033[1;34m${PROMPT} pip3   install --upgrade pip \033[0m" >> /root/Dasan_command.txt
...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '2s/Dasan_Ubuntu18-CUDA10_1-install.sh/Dasan_Ubuntu18-CUDA10_2-install.sh/g' /etc/rc.local  \033[0m" >> /root//root/Dasan_command.txt
...
echo "  재부팅 "
echo -e  "\033[1;34m${PROMPT} reboot \033[0m" >> /root//root/Dasan_command.txt
reboot
