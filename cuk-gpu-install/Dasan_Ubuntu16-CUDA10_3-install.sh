...
echo ""
echo -e  "${PROMPT} git clone https://github.com/pytorch/examples/ " >> /root/dasan_install_log.txt
git clone https://github.com/pytorch/examples/ >> /root/log.txt

echo ""
echo -e  "${PROMPT} python     examples/regression/main.py " >> /root/dasan_install_log.txt
python     examples/regression/main.py >> /root/dasan_install_log.txt 2>&1

echo ""
echo -e  "${PROMPT} python3     examples/regression/main.py " >> /root/dasan_install_log.txt
