...
echo ""
echo -e  "${PROMPT} wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-repo-ubuntu1604_10.1.243-1_amd64.deb " >> /root/dasan_install_log.txt
wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-repo-ubuntu1604_10.1.243-1_amd64.deb >> /root/log.txt

echo ""
echo -e  "${PROMPT} dpkg -i  cuda-repo-ubuntu1604_10.1.243-1_amd64.deb " >> /root/dasan_install_log.txt
dpkg -i  cuda-repo-ubuntu1604_10.1.243-1_amd64.deb >> /root/log.txt
...
echo ""
echo -e  "${PROMPT} tar xvzf cudnn-10.1-linux-x64-v7.6.4.38.tgz " >> /root/dasan_install_log.txt
...
echo ""
echo -e  "${PROMPT} cp  -rp  cuda/include/cudnn.h  /usr/local/cuda-10.1/include/ " >> /root/dasan_install_log.txt
cp  -rp  cuda/include/cudnn.h  /usr/local/cuda-10.1/include/

echo ""
echo -e  "${PROMPT} cp  -rp  cuda/lib64/libcudnn*  /usr/local/cuda-10.1/lib64/ " >> /root/dasan_install_log.txt
cp  -rp  cuda/lib64/libcudnn*  /usr/local/cuda-10.1/lib64/

echo ""
echo -e  "${PROMPT} ls -l /usr/local/cuda-10.1/lib64/libcudnn* " >> /root/dasan_install_log.txt
ls -l /usr/local/cuda-10.1/lib64/libcudnn*
