...
echo -e  "${PROMPT} sed -i '1a bash /root/LISR/1_Server/1-3_Qct/1-3-3_Ubuntu18/1-3-3-2_GPU/Dasan_Ubuntu18-Standard-install.sh >> /root/dasan_install_log.txt' /etc/rc.local   " >> /root/dasan_install_log.txt
sed -i '1a bash /root/LISR/1_Server/1-3_Qct/1-3-3_Ubuntu18/1-3-3-2_GPU/Dasan_Ubuntu18-Standard-install.sh >> /root/dasan_install_log.txt' /etc/rc.local
