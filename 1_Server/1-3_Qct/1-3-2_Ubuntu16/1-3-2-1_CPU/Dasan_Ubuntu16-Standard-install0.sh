...
apt-get install -y xfsprogs ntfs-3g aptitude lvm2 dstat curl smartmontools figlet >> /root/dasan_install_log.txt 2>&1
...
echo ""
echo -e  "\033[1;34m${PROMPT} cat /root/LISR/1_Server/1-2_Supermicro_Etc/1-2-2_Ubuntu16/1-2-2-1_CPU/Install_MSM_Ubuntu.sh  \033[0m" >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-2_Supermicro_Etc/1-2-2_Ubuntu16/1-2-2-1_CPU/Install_MSM_Ubuntu.sh

echo ""
echo -e  "\033[1;34m${PROMPT} bash /root/LISR/1_Server/1-2_Supermicro_Etc/1-2-2_Ubuntu16/1-2-2-1_CPU/Install_MSM_Ubuntu.sh \033[0m" >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-2_Supermicro_Etc/1-2-2_Ubuntu16/1-2-2-1_CPU/Install_MSM_Ubuntu.sh
...
echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x00 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x00 100

sleep 5

echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x01 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x01 100

sleep 5

echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x02 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x02 100

sleep 5

echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x03 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x03 100

sleep 5

echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x04 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x04 100

sleep 5

echo -e  "\033[1;34m${PROMPT} ipmitool  raw 0x30 0x39 0x00 0x00 0x05 100 \033[0m" >> /root/dasan_install_log.txt
ipmitool  raw 0x30 0x39 0x00 0x00 0x05 100
