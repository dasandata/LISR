...
echo ""
echo -e  "\033[1;34m${PROMPT} yum -y update \033[0m" >> /root/dasan_install_log.txt
yum -y update
...
echo -e  "\033[1;34m${PROMPT} grep 'SELINUX=' /etc/selinux/config  \033[0m" >> /root/dasan_install_log.txt
...
echo "  rc.local 등록 "
echo -e  "\033[1;34m${PROMPT} sed -i '13s/Dasan_Centos7-yumupdate-install0.sh/Dasan_Centos7-Standard-install0.sh/g' /etc/rc.d/rc.local    \033[0m" >> /root/dasan_install_log.txt
