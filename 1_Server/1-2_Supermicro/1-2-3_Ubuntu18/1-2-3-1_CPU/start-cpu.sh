...
echo -e  "${PROMPT} sed -i '1a bash /root/LISR/1_Server/1-2_Supermicro/1-2-3_Ubuntu18/1-2-3-1_CPU/Dasan_Ubuntu18-Standard-install0.sh >> /root/dasan_install_log.txt' /etc/rc.local   " >> /root/dasan_install_log.txt
sed -i '1a bash /root/LISR/1_Server/1-2_Supermicro/1-2-3_Ubuntu18/1-2-3-1_CPU/Dasan_Ubuntu18-Standard-install0.sh >> /root/dasan_install_log.txt' /etc/rc.local
