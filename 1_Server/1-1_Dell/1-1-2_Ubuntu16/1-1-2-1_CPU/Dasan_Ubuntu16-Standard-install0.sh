...
echo -e  "\033[1;34m${PROMPT} sed -i '14s/Dasan_Ubuntu16-Standard-install0.sh/Dasan_Ubuntu16-dell-package-install.sh/g' /etc/rc.local    \033[0m" >> /root/dasan_install_log.txt
