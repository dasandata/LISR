...
echo -e  "==================== SMTP for Email Alert mailutils or mailx  ====================" >> /root/dasan_install_log.txt
...
echo ""
## echo -e  "${PROMPT} apt install -y  mailutils  " >> /root/dasan_install_log.txt
...
echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_OMSA_Ubuntu.sh " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_OMSA_Ubuntu.sh >> /root/log.txt
...
echo -e  "==================== Dell RAID Controller Management MSM Alert by Email ====================" >> /root/dasan_install_log.txt
...
echo ""
echo -e  "${PROMPT} cat /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_MSM_Ubuntu.sh

echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-2_Ubuntu16/1-1-2-1_CPU/Install_Dell_MSM_Ubuntu.sh >> /root/log.txt
...
echo -e  "==================== 온도 temperature 모니터링 ipmitool ====================" >> /root/dasan_install_log.txt
