...
echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_OMSA_Ubuntu.sh " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_OMSA_Ubuntu.sh >> /root/log.txt
...
echo ""
echo -e  "${PROMPT} cat /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_MSM_Ubuntu.sh >> /root/log.txt

echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-3_Ubuntu18/1-1-3-1_CPU/Install_Dell_MSM_Ubuntu.sh >> /root/log.txt
