...
echo "  rc.local 등록 "
echo -e  "${PROMPT} sed -i '2s/Dasan_Ubuntu20-Standard-install.sh/Dasan_Ubuntu20-dell-package-Install.sh/g' /etc/rc.local  " >> /root/dasan_install_log.txt
sed -i '2s/Dasan_Ubuntu20-Standard-install.sh/Dasan_Ubuntu20-dell-package-Install.sh/g' /etc/rc.local
