...
echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_OMSA_Ubuntu.sh " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_OMSA_Ubuntu.sh >> /root/log.txt
...
echo -e "For Ubuntu 20.04" >> /root/dasan_install_log.txt

echo ""
echo ""

echo ""
echo -e  "${PROMPT} cat /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_MSM_Ubuntu.sh >> /root/log.txt

echo ""
echo -e  "${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_MSM_Ubuntu.sh  " >> /root/dasan_install_log.txt
bash /root/LISR/1_Server/1-1_Dell/1-1-5_Ubuntu20/1-1-5-2_GPU/Install_Dell_MSM_Ubuntu.sh >> /root/log.txt
