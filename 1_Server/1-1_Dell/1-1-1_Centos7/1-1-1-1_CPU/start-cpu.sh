...
echo -e  "\033[1;34m${PROMPT} sed -i '12a bash /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Dasan_Centos7-yumupdate-install0.sh >> /root/dasan_install_log.txt' /etc/rc.d/rc.local   \033[0m" >> /root/dasan_install_log.txt
