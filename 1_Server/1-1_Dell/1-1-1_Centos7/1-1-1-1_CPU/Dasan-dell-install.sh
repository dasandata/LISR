...
echo ""
echo -e  "\033[1;34m${PROMPT} cat /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_OMSA_CentOS7.sh \033[0m" >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_OMSA_CentOS7.sh

echo ""
echo -e  "\033[1;34m${PROMPT} yes | bash /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_OMSA_CentOS7.sh \033[0m" >> /root/dasan_install_log.txt
...
echo ""
echo -e  "\033[1;34m${PROMPT} cat /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_MSM_CentOS7.sh  \033[0m" >> /root/dasan_install_log.txt
cat /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_MSM_CentOS7.sh

echo ""
echo -e  "\033[1;34m${PROMPT} bash /root/LISR/1_Server/1-1_Dell/1-1-1_Centos7/1-1-1-1_CPU/Install_Dell_MSM_CentOS7.sh \033[0m" >> /root/dasan_install_log.txt
