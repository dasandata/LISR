...
echo -e  "\033[1;34m${PROMPT} sed -i '13a bash /root/LISR/2_Workstation_Desktop/2-2_Ubuntu16/2-2-1_CPU/Dasan_Ubuntu16-Standard-install0.sh >> /root/dasan_install_log.txt' /etc/rc.local  \033[0m" >> /root/dasan_install_log.txt
